        ...
        let card = document.createElement("div")
            ...
            btnComprar.addEventListener("click", () => {
               //alert de libreira
                ...
                comprarProducto(id)// cuando se hace click en la funcion hay que llamar a la funcion comprar producto para pasar el id de ese producto aqui donde se genera el evento porque es la id de productos
            });
    });
}